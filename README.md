...
the output file will go into the pack folder so you can actually put this script anywhere and it'll work fine (as long as node_modules is somewhere above it in the tree)

the format is:
```log
[width x height]	/block/texture.png
```
